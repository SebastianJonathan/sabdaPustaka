		...
		<div class="row row-search">
					...
					<div class="col-md-2 col-filter" style="border-right: 1px black solid; padding-right: 5px; padding-left:10px;">
							...
							<div class="checkbox-container">
								<label for="checkbox_narasumber" class="form-check-label checkbox-label bigger">
												<input type="checkbox" class="form-check-input bigger" id="checkbox_narasumber" name="checkbox_narasumber" value="narasumber" onchange="onChangeCheckbox()">
												Narasumber
								</label>
							</div>
							<div class="checkbox-container">
								<label for="checkbox_event" class="form-check-label checkbox-label bigger">
												<input type="checkbox" class="bigger form-check-input" id="checkbox_event" name="checkbox_event" value="event" onchange="onChangeCheckbox()">
												Event
								</label>
							</div>
							<div class="buttons">
							...
							<button class="btn filter-sm-btn" type="button" data-bs-toggle="offcanvas" data-bs-target="#filter-sm" aria-controls="filter-sm">Filter</button>
								<div class="offcanvas offcanvas-start" data-bs-scroll="true" tabindex="-1" id="filter-sm" aria-labelledby="filter-sm-label">
									...
									<div class="offcanvas-body" >
										<div class="checkbox-container">
											<label for="checkbox_judul" class="form-check-label checkbox-label bigger">
												<input type="checkbox" class="form-check-input bigger" id="checkbox_judul2" onchange="updateOnChecked()" name="checkbox_judul" value="judul">
													Judul
											</label>
										</div>
										<div class="checkbox-container">
												<label for="checkbox_narasumber" class="form-check-label checkbox-label bigger">
														<input type="checkbox" class="form-check-input bigger" id="checkbox_narasumber2" onchange="updateOnChecked()" name="checkbox_narasumber" value="narasumber" >
														Narasumber
												</label>
										</div>
										<div class="checkbox-container">
												<label for="checkbox_event" class="form-check-label checkbox-label bigger">
														<input type="checkbox" class="bigger form-check-input" id="checkbox_event2" onchange="updateOnChecked()" name="checkbox_event" value="event">
														Event
												</label>
										</div>
										<div class="buttons">
			...
			<script>
				...
				function updateOnChecked(){
					...
					const checkbox_narasumber = document.getElementById('checkbox_narasumber');
					const checkbox_event = document.getElementById('checkbox_event');
					const checkbox_judul2 = document.getElementById('checkbox_judul2');
					const checkbox_narasumber2 = document.getElementById('checkbox_narasumber2');
					const checkbox_event2 = document.getElementById('checkbox_event2');
